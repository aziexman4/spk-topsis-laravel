            ...
            <div class="flex flex-col lg:flex-row items-center gap-16">
                ...
                <div class="lg:w-1/2 w-full">
                    <div class="bg-white dark:bg-zinc-900 rounded-3xl p-8 border border-zinc-200 dark:border-zinc-700 shadow-2xl relative overflow-hidden">
                        ...
                        <h4 class="font-mono text-sm font-bold text-zinc-500 mb-4 border-b border-zinc-200 dark:border-zinc-700 pb-2">Formula Perankingan (V<sub>i</sub>)</h4>
                        ...
                        <p class="text-xs text-center text-zinc-500 mt-4">Kandidat dengan nilai V<sub>i</sub> tertinggi adalah rekomendasi utama HRD.</p>
                    </div>
                </div>
            </div>
        </div>
